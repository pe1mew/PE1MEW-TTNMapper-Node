 ...
 * @Date 10-05-2018
 * @version 1.1   Changed Dutycycle for TTN 868 to follow 10% duty cycle.
 *
 */
  ...
  switch (fp)
  {
    ...
    case TTN_EU:
    {
       ...
       */
        ...
        sendRawCommand(F("mac set ch dcycle 3 9"));
        ...
        sendRawCommand(F("mac set ch dcycle 4 9"));
        ...
        sendRawCommand(F("mac set ch dcycle 5 9"));
        ...
        sendRawCommand(F("mac set ch dcycle 6 9"));
        ...
        sendRawCommand(F("mac set ch dcycle 7 9"));
